    ...
    public static void main(String[] args) {
        ...
        switch(pilihan){
            case 1 ->{
                ...
                Novel novel2= new Novel(judul, penulis, tahun, genre, sinopsis);
                System.out.println(novel2.getNovelDetail());
            }
            case 2 ->{
            System.out.print("Judul: ");
                judul = input.nextLine();
                ...
                System.out.print("Sinopsis: ");
                sinopsis = input.nextLine();
                Komik komik2= new Komik(judul, penulis, tahun, volume, sinopsis);
                System.out.println(komik2.getKomikDetail());
            }
